...
page_remove_pte(pde_t *pgdir, uintptr_t la, pte_t *ptep) {
    ...
    if (*ptep & PTE_P) {                                //(1) check if this page table entry is present
        struct Page *page = pa2page(PTE_ADDR(*ptep));   //(2) find corresponding page to pte
